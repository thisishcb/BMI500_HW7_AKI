...
select ie.subject_id, ie.hadm_id, ie.icustay_id
  , case
    ...
    , LEAST_ARRAY([cv_ce.charttime, cv_ie.charttime, cv_oe.charttime, mv_ce.charttime, mv_ie.charttime, mv_de.charttime, mv_pe.charttime]) AS CHARTTIME
FROM `physionet-data.mimiciii_clinical.icustays` ie
left join cv_ce
...
order by ie.icustay_id, charttime;